...
class OpponentBuilder:
    ...
    def monstermaker(self, level):
        ...
        weapon_list = []
        percentile = chance()
        monsters = {"mountain": (("Kobold", 75, 3, 2, 0, ("sword", "axe", "mace")),
                                 ("Dwarf", 100, 2, 3, 0, ("hammer", "mace", None)),
                                 ("Goblin", 50, 4, 1, 0, ("sword", "axe", "dagger"))),
                    "forest": (("Wurm", 100, 4, 1, 0, (None, None, None)),
                               ("Spider", 75, 2, 3, 0, (None, None, None)),
                               ("Sprite", 50, 1, 2, 2, ("dagger", "sword", None))),
                    "swamp": (("Bat", 50, 2, 3, 0, (None, None, None)),
                              ("Rat", 50, 3, 2, 0, (None, None, None)),
                              ("Skeleton", 75, 2, 1, 2, ("sword", "mace", "axe"))),
                    "plains": (("Giant", 110, 3, 2, 0, ("sword", "mace", "axe")),
                               ("Knight", 100, 2, 3, 0, ("sword", "axe", None)),
                               ("Priest", 50,  0, 2, 3, (None, None, None))),
                    "island": (("Flayer", 50, 0, 1, 4, (None, None, None)),
                               ("Octopus", 75, 4, 1, 0, (None, None, None)),
                               ("Eagle", 100, 3, 2, 0, (None, None, None)))}
